from .unet import UNet,  MCNet2d_v2, MCNet2d_v3, DTS_OAP_v4_attention
...
def net_factory(net_type="unet", in_chns=1, class_num=4, mode="train"):
    ...
    elif net_type == "DTS_OAP_v4_attention":
        net = DTS_OAP_v4_attention(in_chns=in_chns, class_num=class_num).cuda()
